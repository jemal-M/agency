...
export async function POST(req: NextRequest): Promise<NextResponse> {
  ...
  try {
    ...
    // Prepare income data
    const expenseData: Prisma.IncomeCreateInput = {
      category,
      source,
      amount,
      date,
    ...
    console.log("Attempting to create income with data:", expenseData)
    ...
    console.log("Income created successfully:", newExpense)
