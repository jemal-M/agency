...
import { fetchIncomeRequest } from "@/lib/reducers/incomereducer"
...
const IncomePage = () => {
  ...
  const totalPages = useAppSelector((state) => state.income.totalPages)
  const totalCount = useAppSelector((state) => state.income.totalCount)

  useEffect(() => {
    dispatch(fetchIncomeRequest({ currentPage }))
  ...
  return (
    ...
    <div className="container mx-auto px-4 py-3">
      <h1 className="text-l mb-2">Income List</h1>
      ...
      <div className="flex justify-end items-end mb-4">
        <Link href="/income/create" className="bg-green-500 px-2 py-2 text-sm rounded-lg text-white">
          Add Income
        </Link>
      </div>
