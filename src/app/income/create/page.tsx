...
export default function CreateIncomePage() {
  ...
  const incomeCreated=useAppSelector((state)=>state.income.incomeCreated)
...
if(incomeCreated!=null){
    toast({
        ...
        description: "Your new income entry has been successfully added.",
      })
      router.push("/income")
}
else{
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      dispatch(registerIncomeRequest(values));
  ...
  return (
    ...
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold mb-6">Create New Income Entry</h1>
      <Form {...form}>
